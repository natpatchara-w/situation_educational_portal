...
OPENAI_CHAT_REASONING_EFFORT = os.environ.get("OPENAI_CHAT_REASONING_EFFORT", "medium")
...
CHAT_VECTOR_SEARCH_ENABLED = env_bool("DJANGO_CHAT_VECTOR_SEARCH_ENABLED", True)
